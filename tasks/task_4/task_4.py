...
class EmbeddingClient:
    ...
    def __init__(self, model_name, project, location):
        ...
        # Learn more about the VertexAIEmbeddings wrapper from Langchain here
        # https://python.langchain.com/docs/integrations/text_embedding/google_generative_ai
        self.model_name = model_name
        self.project = project
        self.location = location
        os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "C:/Users/rukmi/Downloads/mission-quizify/authentication.json"
        self.client = VertexAIEmbeddings(model_name=self.model_name, project=self.project, location=self.location)
