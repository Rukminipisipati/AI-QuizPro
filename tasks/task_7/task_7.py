...
import os
import sys
sys.path.append(os.path.abspath('C:/Users/rukmi/Downloads/mission-quizify'))
...
class QuizGenerator:
    ...
    def init_llm(self):
        ...
        Note: Ensure we have appropriate access or API keys if required by the model or platform.
        """
        self.llm = VertexAI(model_name="gemini-pro", temperature=0.3, max_output_tokens=400)
    ...
    def generate_question_with_vectorstore(self):
        ...
        #print(type(RunnablePassthrough()))
