    ...
    with screen.container():
        ...
        with st.form("Load Data to Chroma"):
            ...
            if submitted:
                ...
                # Following is the line to test the query_chroma_collection() method
